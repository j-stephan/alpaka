        ...
        namespace unit
        {
            namespace math
            {
                ...
                struct Buffer
                {
                    ...
                    alpaka::Accessor<TData*, TData, Idx, Dim::value, alpaka::ReadWriteAccess> const pHostBuffer;
                    alpaka::Accessor<TData*, TData, Idx, Dim::value, alpaka::ReadWriteAccess> const pDevBuffer;
