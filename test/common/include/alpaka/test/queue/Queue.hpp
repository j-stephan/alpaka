...
namespace alpaka
{
    ...
    namespace test
    {
        ...
        namespace traits
        {
            ...
            struct IsBlockingQueue<
                alpaka::QueueGenericThreadsBlocking<TDev>>
            {
            ...
            template<typename TDev>
            struct IsBlockingQueue<
                alpaka::QueueGenericThreadsNonBlocking<TDev>>
            {
            ...
            template<>
            struct IsBlockingQueue<
                alpaka::QueueUniformCudaHipRtBlocking>
            {
                static constexpr bool value = true;
            };
            ...
            template<>
            struct IsBlockingQueue<
                alpaka::QueueUniformCudaHipRtNonBlocking>
            {
                static constexpr bool value = false;
            };
#endif
