...
if(ALPAKA_ACC_GPU_CUDA_ENABLE)
    ...
    if(ALPAKA_CUDA_VERSION VERSION_LESS 9.0)
        ...
        if(NOT CUDA_FOUND)
            ...
            option(ALPAKA_CUDA_FAST_MATH "Enable fast-math" OFF)
            ...
            if(ALPAKA_CUDA_COMPILER MATCHES "clang")
                ...
                if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
                    ...
                    elseif(CUDA_VERSION VERSION_EQUAL 11.1 OR CUDA_VERSION VERSION_EQUAL 11.2)
                ...
                elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
                    ...
                    elseif(CUDA_VERSION VERSION_EQUAL 11.1 OR CUDA_VERSION VERSION_EQUAL 11.2)
                        if(CMAKE_CXX_COMPILER_VERSION GREATER_EQUAL 11.0)
                            message(FATAL_ERROR "NVCC 10.2 does not support clang 11+. Please use clang 4, 5, 6, 7, 8, 9 or 10!")
                        endif()
                    endif()
                endif()
...
if(ALPAKA_ACC_GPU_HIP_ENABLE)
    ...
    if(ALPAKA_HIP_VERSION VERSION_LESS 4.0)
        ...
        if(NOT HIP_FOUND)
            ...
            option(ALPAKA_HIP_FAST_MATH "Enable fast-math" OFF)
...
if(ALPAKA_ACC_SYCL_ENABLE)
    ...
    #-----------------------------------------------------------------------------------------------------------------
    # Path to ComputeCpp SDK - required for device-side tuples
    set(ALPAKA_COMPUTECPP_SDK_DIR "" CACHE PATH "Path to the ComputeCpp SDK (root directory)")
    if(NOT EXISTS ${ALPAKA_COMPUTECPP_SDK_DIR}/include/stl-tuple/STLTuple.hpp)
...
if(ALPAKA_ACC_SYCL_ENABLE)
    ...
    target_compile_definitions(alpaka INTERFACE "BOOST_LANG_SYCL")
    if(ALPAKA_SYCL_PLATFORM_ONEAPI)
